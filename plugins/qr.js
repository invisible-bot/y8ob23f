...
// Sentances
const QR_DESC = "එය text Qr කේතයට පරිවර්තනය කරම්න"
...
Asena.addCommand({pattern: 'qr ?(.*)', fromMe: false, desc: QR_DESC}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: "Copyright © 2021 | පම්කයා "})
